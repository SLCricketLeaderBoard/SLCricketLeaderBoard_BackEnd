...
public class TournamentClubCaptainService {
	...
	private Boolean tournamentClubCaptainObjectValid(TournamentClubCaptain object) {
		if (object != null) {
			if (object.getCaptainId() != null && object.getViceCaptainId() != null
					&& object.getTournamentClubId() != null) {
				...
				if (playerRepository.existsById(p1) && playerRepository.existsById(p2)
						&& tournamentClubRepository.existsById(tc)) {
					return true;
				}
			}
		}
