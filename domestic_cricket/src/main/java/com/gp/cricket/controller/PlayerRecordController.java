...
public class PlayerRecordController {
	...
	public Integer recordBallerRecord(@Valid @RequestBody PlayerRecord playerRecord) {
	...
	public PlayerRecord getPlayerRecord(@PathVariable("playerSelectedId") Integer playerSelectedId){
