...
public class TournamentClubCaptainController {
	...
	@Autowired
	TournamentClubCaptainService tournamentClubCaptainService;

	@PostMapping("tournamentclubcaptain")
	public ResponseEntity<Integer> tournamentCaptainsSave(
			@Validated @RequestBody TournamentClubCaptain tournamentClubCaptain) {
	...
	public ResponseEntity<List<Player>> getTournamentCaptains(@PathVariable("tournamentId") Integer tournamentId,
	...
	public ResponseEntity<Integer> tournamentCaptainsUpdate(@Validated @RequestBody TournamentClubCaptain tournamentClubCaptain){
		System.out.println("-----------------");
