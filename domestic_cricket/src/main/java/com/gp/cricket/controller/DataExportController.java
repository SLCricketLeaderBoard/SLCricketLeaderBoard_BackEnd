...
public class DataExportController {
	...
	public List<PlayerMatchBatmenRecordExport> getBatmenRecord(@PathVariable("playerId")Integer playerId){
		return dataExportService.getBatmenRecord(playerId);
	}
	
	@GetMapping("get/player/baller/{playerId}")
	public List<PlayerMatchBallerRecordExport> getBallerRecord(@PathVariable("playerId")Integer playerId){
