...
public class ClubPayment {
	...
	public ClubPayment(Integer clubPaymentId, @NotNull @Min(0) Double amount, @NotNull LocalDate date,
			@NotNull Integer paymentForYear, @NotNull Club clubId) {
		super();
	...
	public String toString() {
		return "ClubPayment [clubPaymentId=" + clubPaymentId + ", amount=" + amount + ", date=" + date
				+ ", paymentForYear=" + paymentForYear + ", clubId=" + clubId + "]";
	}
